    ...
    <div className="container-left">
      ...
      <div className="tabs">
        <Button
          ...
          style={{
            border: "none",
            backgroundColor: showChatHistory ? "var(--brand-yellow)" : "transparent",
            color: showChatHistory ? "var(--text)" : "var(--muted)",
            cursor: "pointer",
            minWidth: "150px",
            padding: "12px 20px",
            fontWeight: showChatHistory ? 600 : 400,
            borderRadius: "0",
            borderBottom: showChatHistory ? "3px solid var(--brand-yellow)" : "3px solid transparent",
        ...
        <Button
          ...
          style={{
            border: "none",
            backgroundColor: showRequests ? "var(--brand-yellow)" : "transparent",
            color: showRequests ? "var(--text)" : "var(--muted)",
            cursor: "pointer",
            minWidth: "150px",
            padding: "12px 20px",
            fontWeight: !showChatHistory ? 600 : 400,
            borderRadius: "0",
            borderBottom: showRequests ? "3px solid var(--brand-yellow)" : "3px solid transparent",
            transition: "all 0.3s ease"
          }}
            ...
            {selectedChat ? (
              <>
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  />
                  <span style={{ fontFamily: "Montserrat, sans-serif", color: "#111827", fontWeight: 500 }}>
